...
const NewsLatterBox = () => {
  ...
  return (
    ...
    >
      ...
      <p className="mb-11 border-b border-body-color border-opacity-25 pb-11 text-base leading-relaxed text-body-color  dark:text-blue-100 dark:border-white dark:border-opacity-25">
      ...
      <div>
        <input
          ...
          className="border-stroke dark:text-body-color  dark:text-blue-100-dark dark:shadow-two mb-4 w-full rounded-sm border bg-[#f8f8f8] px-6 py-3 text-base text-body-color  dark:text-blue-100 outline-none focus:border-primary dark:border-transparent dark:bg-[#2C303B] dark:focus:border-primary dark:focus:shadow-none"
        />
        <input
          type="email"
          name="email"
        ...
        />
        <p className="dark:text-body-color  dark:text-blue-100-dark text-center text-base leading-relaxed text-body-color  dark:text-blue-100">
